...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sales_salesreturnitem', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.SalesItem'], null=True, blank=True)),
            ('return_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('discount_amount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.create_table(u'sales_salesreturn', (
            ...
            ('round_off', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('grand_total', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'sales.salesreturn': {
            ...
            'grand_total': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'round_off': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'sales': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sales.Sales']"}),
            'total': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'sales.salesreturnitem': {
            'Meta': {'object_name': 'SalesReturnItem'},
            'discount_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
