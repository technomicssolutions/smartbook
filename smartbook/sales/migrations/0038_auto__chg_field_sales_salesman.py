...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sales.salesman'
        db.alter_column(u'sales_sales', 'salesman_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    def backwards(self, orm):

        # Changing field 'Sales.salesman'
        db.alter_column(u'sales_sales', 'salesman_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Staff'], null=True))
    models = {
        u'auth.group': {
